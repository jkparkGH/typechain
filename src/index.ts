...
const lyn = new Person("lyn", 29, "male", 68);
...
const sayHello2 = (person: Human): void => {
  console.log(
    `### sayHello 3 ::  HI, My name is ${person.name}, I ${person.age} years old and I'm ${person.gender}`
  );
};
const sayHello3 = ({ name, age, gender, getPersonWeight }: Person): void => {
  console.log(
    `### sayHello 2 ::  HI, My name is ${name}, I ${age} years old and I'm ${gender}, my weight ${getPersonWeight()}`
  );
};
